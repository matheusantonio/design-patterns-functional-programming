...
\begin{lstlisting}[caption={Exemplo de Código Imutável. Fonte: O Autor (2021)},label=imutablevar]
...
\begin{lstlisting}[caption={Exemplo sem Funções de Alta Ordem. Fonte: O Autor (2021)},label=nohof]
